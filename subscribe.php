...
<table width="774" height="457" border="1" align="center" >
  ...
  <tr>
    ...
    <form action="subscribe_action.php" name="frm" method="post" onsubmit="return ValidateForm()">
    <table width="327" border="0" align="center" cellpadding="1" cellspacing="3">
    <caption> Subsctibe as a Mess Manager<br />
      </caption>
      <?php
	if($_REQUEST['y']=='user_exist') {?>
      ...
      <tr>
        ...
        <td>Your Mess Title:</td>
      </tr>
      <tr>
        <td><input name="mess_title" type="text" id="mess_title" size="40" maxlength="40" />*<br />
        Example:Dhaka Mess, New York Mess
      ...
      <tr>
        <td width="321">Your First Name:</td>
      </tr>
      <tr>
        <td><input name="mng_first_name" type="text" id="mng_first_name" size="15" maxlength="15" /></td>
      </tr>
      <tr>
        <td>Your Last Name:</td>
      </tr>
      <tr>
        <td><input name="mng_last_name" type="text" id="mng_last_name" size="15" maxlength="15" /></td>
      </tr>
      <tr>
        <td>Your Country:</td>
      </tr>
...
<option value="Zimbabwe">Zimbabwe</option>
      ...
      <tr>
        <td><input name="mng_email" type="text" id="mng_email" size="30" maxlength="30" />
          *</td>
      </tr>
      <tr>
        <td>User Name:</td>
	...
	if($_REQUEST['y']=='user_exist') {?>
     <tr>
      ...
      <tr>
        <td><input name="mng_user_name" type="text" id="mng_user_name" size="30" maxlength="30" />
          *</td>
      </tr>
      <tr>
        <td>Password:</td>
   ...
   <input name="mng_password" type="password" id="mng_password" size="20" maxlength="20"  onKeyUp="checkPassword(this.value)" />
